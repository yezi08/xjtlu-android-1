...
.factory('$mmCourse', function($mmSite, $translate, $q, $log, $mmEvents, $mmSitesManager, mmCoreEventCompletionModuleViewed) {
    ...
    var self = {},
        mods = ["assign", "assignment", "book", "chat", "choice", "data", "database", "date", "external-tool",
            ...
            "resource", "scorm", "survey", "url", "wiki", "workshop", "activequiz", "allocationform", "attendance", "bigbluebuttonbn", "certificate", "choicegroup", "dialogue", "etherpadlite", "helixmedia", "lightboxgallery", "pcast", "pearson", "publication", "questionnaire", "reservation", "scheduler", "customcert"
        ],
